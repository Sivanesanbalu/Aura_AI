...
const InterviewSkeletonCard = () => (
  <div className="rounded-2xl p-6 bg-white border border-black shadow-md">
    ...
    <div className="my-10">
      ...
      >
        ...
        {!loading && (
          <Button
            ...
            className="transition-all duration-300 bg-white border border-black text-black hover:bg-gray-100 hover:border-black hover:scale-105 active:scale-95"
          >
      ...
      <AnimatePresence>
        {loading ? (
          ...
          >
            <Sparkles
              className="h-16 w-16 mx-auto mb-5 text-black"
              strokeWidth={1}
            />
            ...
            <p className="text-md mb-8 text-black max-w-sm mx-auto">
              You haven't conducted any interviews yet. Create one now to get
              started with our AI-powered platform.
            </p>
            <Button
              onClick={() =>
                (window.location.href = "/dashboard/create-interview")
              }
